...
Gem::Specification.new do |s|
  ...
  s.files = ["README.md", "Rakefile", "init.rb", "install.rb", "lib/decimalizer.rb", "spec/decimalizer_spec.rb", "spec/spec_helper.rb", "tasks/decimalizer_tasks.rake", "uninstall.rb", "Manifest", "decimalizer.gemspec"]
